        ...
        <div className=''>
          ...
          <div className='mx- mt-2'>
            ...
            <div>
              ...
              <p className='bg-black text-white p-3 w-[550px] rounded-md'><b>Hotline: 0967.077.882</b> </p>
              <p className='bg-black text-white p-3 w-[550px] rounded-md'><b>CSKH : 0383.226.567 </b> </p>
            </div>
            <div>
