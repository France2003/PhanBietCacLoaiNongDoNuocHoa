...
const PageHome = () => {
  return (
    <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
      ...
      <i className='text-center text-[13px]'>PHÂN BIỆT CÁC LOẠI NỒNG ĐỘ CỦA NƯỚC HOA </i>
      ...
      <div className='mx-9'>
        ...
        <div>
          <img src={img7I} className='h-[500px] w-[1050px] mt-3' alt="ỔNG QUAN NỒNG ĐỘ CỦA NƯỚC HOA" />
          <i className='text-center text-[13px]'>TỔNG QUAN NỒNG ĐỘ CỦA NƯỚC HOA</i>
        </div>
      </div>
